...
// file.
func (app *VoidApp) ExportAppStateAndValidators(forZeroHeight bool, jailAllowedAddrs, modulesToExport []string) (servertypes.ExportedApp, error) {
...
func (app *VoidApp) prepForZeroHeightGenesis(ctx sdk.Context, jailAllowedAddrs []string) {
