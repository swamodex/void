...
func initAppConfig() (string, interface{}) {
	...
	//
	// In void, we set the min gas prices to 0.25uvoid.
	srvCfg.MinGasPrices = "0.25uvoid"
...
func initRootCmd(
	...
	rootCmd.AddCommand(
		genutilcli.InitCmd(basicManager, void.DefaultNodeHome),
		NewTestnetCmd(basicManager, banktypes.GenesisBalancesIterator{}),
		debug.Cmd(),
		confixcmd.ConfigCommand(),
		pruning.Cmd(newApp, void.DefaultNodeHome),
		snapshot.Cmd(newApp),
	)

	server.AddCommandsWithStartCmdOptions(rootCmd, void.DefaultNodeHome, newApp, appExport, server.StartCmdOptions{
...
// genesisCommand builds genesis-related `void genesis` command. Users may provide application specific commands as a parameter
func genesisCommand(txConfig client.TxConfig, basicManager module.BasicManager, cmds ...*cobra.Command) *cobra.Command {
	cmd := genutilcli.Commands(txConfig, basicManager, void.DefaultNodeHome)
...
// appExport creates a new void (optionally at a given height) and exports state.
func appExport(
	logger log.Logger,
	db dbm.DB,
	traceStore io.Writer,
