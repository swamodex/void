...
Example:
	...
	cmd.Flags().String(flagNodeDaemonHome, "void", "Home directory of the node's daemon configuration")
...
func startTestnet(cmd *cobra.Command, args startArgs) error {
	networkConfig := network.DefaultConfig(void.NewTestNetworkFixture)
